...
public class SmsBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      /*  if (isApplicationForeground(context)) {
           *//* Intent intent = new Intent(ACTION_REMOTE_MESSAGE);
            ...
            if (!isIsolateRunning.get()) {
                backgroundMessageQueue.add("test");
            } else {
                executeDartCallbackInBackgroundIsolate(
                        backgroundContext, "test", null);
    ...
    private static void executeDartCallbackInBackgroundIsolate(
            Context context, String remoteMessage, final CountDownLatch latch) {
        ...
        messageData.put("text",remoteMessage);
